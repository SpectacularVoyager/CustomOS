...
#define AHCI_HBA_PxIS_CPDS 31  // Cold Port Detect Status
#define AHCI_HBA_PxIS_TFES 30  // Task File Error Status
#define AHCI_HBA_PxIS_HBFS 29  // Host Bus Fatal Error Status
#define AHCI_HBA_PxIS_HBDS 28  // Host Bus Data Error Status
#define AHCI_HBA_PxIS_IFS  27  // Interface Fatal Error Status
#define AHCI_HBA_PxIS_INFS 26  // Interface Non-fatal Error Status
#define AHCI_HBA_PxIS_OFS  24  // Overflow Status
#define AHCI_HBA_PxIS_IPMS 23  // Incorrect Port Multiplier Status
#define AHCI_HBA_PxIS_PRCS 22  // PhyRdy Change Status
#define AHCI_HBA_PxIS_DMPS 07  // Device Mechanical Presence Status
#define AHCI_HBA_PxIS_PCS  06  // Port Connect Change Status
#define AHCI_HBA_PxIS_DPS  05  // Descriptor Processed
#define AHCI_HBA_PxIS_UFS  04  // Unknown FIS Interrupt
#define AHCI_HBA_PxIS_SDBS 03  // Set Device Bits Interrupt
#define AHCI_HBA_PxIS_DSS  02  // DMA Setup FIS Interrupt
#define AHCI_HBA_PxIS_PSS  01  // PIO Setup FIS Interrupt
#define AHCI_HBA_PxIS_DHRS 00  // Device to Host Register FIS Interrupt
enum {
...
} __attribute__((packed)) AHCI_FIS_REG_H2D;
...
} __attribute__((packed)) AHCI_FIS_REG_D2H;
typedef struct
{
	// DWORD 0
...
} __attribute__((packed)) AHCI_FIS_DATA;
typedef struct
{
	// DWORD 0
...
} __attribute__((packed)) AHCI_FIS_PIO_SETUP;
typedef struct
{
	// DWORD 0
...
} __attribute__((packed)) AHCI_FIS_DMA_SETUP;
...
} __attribute__((packed)) AHCI_RECIEVED_FIS;
...
} __attribute__((packed)) AHCI_HBA_CMD_HEADER;
